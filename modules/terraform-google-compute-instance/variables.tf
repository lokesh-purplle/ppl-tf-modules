...
variable "labels" {
  ...
  default     = { monitor = "no", team = "devops", service_type = "app" }
}


variable "additional_disk_type" {
  type        = string
  description = "Disk type for additional disk:  (Default: pd-balanced)"
  default     = "pd-balanced"
}

variable "bootdisk_type" {
  type        = string
  description = "Disk type for vm boot  disk:  (Default: pd-balanced)"
  default     = "pd-balanced"
}

variable "assign_public_ip" {
  type        = bool
  description = "this will decide whether vm will have public ip or not, possible values are public/priivate (Default: private)"
  default     = false
}
